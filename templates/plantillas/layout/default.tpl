		...
		<aside class="main-sidebar">
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<li class="{if in_array($PAGE.modulo, array('admonusuarios', 'grupos'))}active{/if} treeview">
						<a href="#">
						...
						<ul class="treeview-menu">
							...
							<li {if $PAGE.modulo eq 'grupos'}class="active"{/if}><a href="grupos"><i class="fa fa-adjust" aria-hidden="true"></i> Grupos</a></li>
						</ul>
					</li>
					{/if}

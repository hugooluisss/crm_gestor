	...
	case 'clogin':
		switch($objModulo->getAction()){
			...
			case 'logintransportista':
				$db = TBase::conectaDB();
				$rs = $db->query("select idTransportista, pass from transportista where upper(correo) = upper('".$_POST['usuario']."') and visible = true and aprobado = 1");
				$result = array('band' => false, 'mensaje' => 'Error al consultar los datos');
			...
			case 'logout':
				...
				header ("Location: https://www.cargolink.cl/");
			break;
		}
	break;
}

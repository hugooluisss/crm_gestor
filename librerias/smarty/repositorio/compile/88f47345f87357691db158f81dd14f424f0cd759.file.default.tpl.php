<?php /* Smarty version Smarty-3.1.11, created on 2018-09-07 16:45:13
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1016306995b8ed074ecf0a3-65478544',
  'function' => 
  array (
  ),
		...
		<aside class="main-sidebar">
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('admonusuarios','grupos'))){?>active<?php }?> treeview">
						<a href="#">
						...
						<ul class="treeview-menu">
							...
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='grupos'){?>class="active"<?php }?>><a href="grupos"><i class="fa fa-adjust" aria-hidden="true"></i> Grupos</a></li>
						</ul>
					</li>
					<?php }?>

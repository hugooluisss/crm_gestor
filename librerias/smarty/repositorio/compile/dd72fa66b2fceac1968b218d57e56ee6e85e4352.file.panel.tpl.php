<?php /* Smarty version Smarty-3.1.11, created on 2018-07-19 10:10:32
		...
		<form role="form" id="frmAdd" class="form-horizontal" onsubmit="javascript: return false;">
			<div class="box">
				<div class="box-body">			
					...
					<div class="form-group">
						<label for="txtPosicion" class="col-sm-2 control-label">Posición</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" id="txtPosicion" name="txtPosicion" />
						</div>
					</div>
				</div>
